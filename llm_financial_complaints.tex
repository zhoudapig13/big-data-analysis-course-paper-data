...
\footnotetext{数据集来自美国消费者金融保护局（Consumer Financial Protection Bureau, CFPB）公开的 \href{https://www.consumerfinance.gov/data-research/consumer-complaints/}{Consumer Complaint Database}。代码和实验数据已上传至 \href{https://github.com/zhoudapig13/big-data-analysis-course-paper-data}{GitHub 仓库：大数据分析课程论文数据}。}
\endgroup
